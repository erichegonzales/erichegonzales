              ...
              <Row>
                <Col>
                  <div className="left-div who">
                    <h1>Who I Am</h1>
                    <p>
                      I am a software engineer experienced in creating
                      full-stack applications. My skills include, but are not
                      limited to, Ruby, Rails, JavaScript, React, Python,
                      Django, Java, HTML, CSS, Git, PostgreSQL, and MySQL. I
                      graduated from Flatiron School bootcamp in October 2022
                      where I learned JavaScript with React and Ruby on Rails.
                      I'm pursuing full-stack or back-end development roles to
                      begin my career in the tech industry.
                    </p>
                  </div>
                </Col>
                <Col></Col>
                ...
                <Col>
                  <div className="right-div bring">
                    ...
                    <p>
                      ...
                      help when needed and helps others. That's what I
                      contribute, along with a bright smile, a bubbly
                      personality, and a pleasure to work with.
                    </p>
                  </div>
                </Col>
                <Image
                ...
                <Col>
                  <div className="right-div background">
                    ...
                    <p>
                      ...
                      Bachelor's degree, double-majoring in Physics and
                      Astronomy. I studied topics such as Astrophysics, Quantum
                      Mechanics, Thermodynamics, Solid State Physics, and more.
                      I learned Java OOP in a Data Structures {"& "} Algorithms
                      course, and I completed my senior thesis using Python. I
                      have taken Calculus I/II, Multivariable Calculus, Linear
                      Algebra, Applied Math, and Statistics.
                    </p>
                  </div>
                </Col>
                <Image
                  ...
                  <Col>
                    ...
                    <p className="img-cred card-cred">
                      ...
                      <Card.Body>
                        <hr />
                        <Card.Text>
                          Browse the projects I've worked on
                        </Card.Text>
                  ...
                  <Col>
                    ...
                    <p className="img-cred card-cred">
                      ...
                      <Card.Body>
                        <hr />
                        <Card.Text>
                          Find me online or send me a message
                        </Card.Text>
                        <Button variant="primary">Visit page</Button>
                      </Card.Body>
                      <Card.Footer></Card.Footer>
