        ...
        <div className="projects-div">
          ...
          <Card id="allthingsurf">
            <Card.Body>
              ...
              <Card.Text>
                ...
                community to connect by sharing content, lessons, and news.
                Users can create posts and utilize their feed to establish their
                personal brand or keep up with other surfers in the community.
                Users can also register as coaches to create lessons that
                surfers can request to book.
          ...
          <Card>
            <Card.Body>
              ...
              <Card.Text>
                ...
                find safe, secure, and affordable housing options nearby. When
                the user inputs their information, it calculates a personalized
                listing of eligible houses. There is a resources page that
                offers a marketplace for free or cheap furniture and assistance
                for identification and government programs.
              </Card.Text>
            </Card.Body>
            <Card.Footer>
              <small className="text-muted">
          ...
          <Card>
            <Card.Body>
              ...
              <Card.Text>
                ...
                include minimaps, quizzes, a drawing board, a personalized
                profile with a progress bar, login/logout, and authentication.
              </Card.Text>
            </Card.Body>
            <Card.Footer>
              <small className="text-muted">
          ...
          <Card>
            ...
            <Card.Footer>
              <small className="text-muted">
                {" "}
                React {dot} Ruby on Rails {dot} August 2022
                <br /> 48 hour Flatiron hackathon project {dot} Made in a
                3-person team
              </small>
            </Card.Footer>
          </Card>
          ...
          <Card>
            <Card.Body>
              ...
              <Card.Text>
                ...
                income, investments, debts, bills, tax information, and any
                daily expenses. The app provides a visualization of the results
                in a table and pie chart.
              </Card.Text>
            </Card.Body>
            <Card.Footer>
              <small className="text-muted">
          ...
          <Card>
            <Card.Body>
              ...
              <hr />
              <Card.Text>
                This Java based calculator will be able to add, subtract,
                multiply and divide polynomials using linked lists.
              </Card.Text>
            </Card.Body>
            <Card.Footer>
              <small className="text-muted">
